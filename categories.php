    ...
    <div class="products">
      ...
      <div class="section_container">
        <div class="container">
          <div class="row">
            <div class="col">
              <form class="products_container grid" method="POST">

                <!-- Product -->
                <?php
                $query = $koneksi->query("SELECT * FROM `goods`");
                  ...
                  <div class="product grid-item <?php echo $pecah['goods_tag'] ?>">
                    <div class="product_inner">
                      ...
                      <div class="product_content text-center">
                        <div class="product_title"><a href="product.php"><?php echo $pecah['goods_name'] ?></a></div>
